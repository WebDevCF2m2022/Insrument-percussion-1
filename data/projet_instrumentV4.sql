...
-- -----------------------------------------------------
-- Table `projet_instrument`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projet_instrument`.`users` ;

CREATE TABLE IF NOT EXISTS `projet_instrument`.`users` (
...
CREATE UNIQUE INDEX `login_UNIQUE` ON `projet_instrument`.`users` (`login` ASC) ;


-- -----------------------------------------------------
-- Table `projet_instrument`.`users_has_instruments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projet_instrument`.`users_has_instruments` ;

CREATE TABLE IF NOT EXISTS `projet_instrument`.`users_has_instruments` (
  ...
  CONSTRAINT `fk_users_has_instruments_users1`
    ...
    REFERENCES `projet_instrument`.`users` (`idusers`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_users_has_instruments_instruments1_idx` ON `projet_instrument`.`users_has_instruments` (`instruments_id` ASC) ;

CREATE INDEX `fk_users_has_instruments_users1_idx` ON `projet_instrument`.`users_has_instruments` (`users_idusers` ASC) ;
